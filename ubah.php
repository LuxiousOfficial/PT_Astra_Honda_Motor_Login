            ...
            <div class="row">
                <div class="col-md-12 col-12">
                   ...
                   <input type="hidden" name="transkriplama" value="<?= $karyawan["transkrip"]; ?>">
                    ...
                    <!-- Pas Foto -->
                    <div class="mb-4">
                        <label for="formFile" class="form-label">Uplode Pas Photo Anda</label>
                    ...
                    <!-- Ktp -->
                    <div class="mb-4">
                        <label for="formFile" class="form-label">Uplode Ktp Anda</label>
                        <input class="form-control" type="file" id="formFile" name="file">
                    </div>
                    <!-- End ktp -->
                    ...
                    <!-- cv -->
                    <div class="mb-4">
                        <label for="formFile" class="form-label">Uplode CV anda</label>
                        <input class="form-control" type="file" id="formFile" name="file">
                    </div>
                    <!-- End cv -->
                    ...
                    <!-- ijazah -->
                    <div class="mb-4">
                        <label for="formFile" class="form-label">Uplode ijazah anda</label>
                        <input class="form-control" type="file" id="formFile" name="file">
                    </div>
                    <!-- End ijazah -->
                    ...
                    <!-- transkrip nilai -->
                    <div class="mb-4">
                        <label for="formFile" class="form-label">Uplode transkrip nilai anda</label>
                        <input class="form-control" type="file" id="formFile" name="file">
                    </div>
                    <!-- End transkrip nilai -->
